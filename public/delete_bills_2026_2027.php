...
// Bootstrap Laravel (paths adjusted for public/ subfolder)
...
if (!$isCli) {
    echo "<br><strong>PENTING:</strong> Segera hapus file <code>delete_bills_2026_2027.php</code> dari folder public hosting Anda sekarang demi keamanan.";
}
