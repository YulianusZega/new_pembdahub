    ...
    <div class="mb-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-1">Perbarui data pegawai {{ $employee->full_name }}</p>
            </div>
        </div>
    </div>
            ...
            <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <div class="flex gap-6">
                            <label class="inline-flex items-center">
                                <input type="radio" name="gender" value="L" {{ old('gender', $employee->gender) == 'L' ? 'checked' : '' }} required class="w-4 h-4 text-blue-600 focus:ring-blue-500">
                                <span class="ml-2">Laki-laki</span>
                            </label>
                            <label class="inline-flex items-center">
                                <input type="radio" name="gender" value="P" {{ old('gender', $employee->gender) == 'P' ? 'checked' : '' }} required class="w-4 h-4 text-blue-600 focus:ring-blue-500">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="number" name="children_count" id="children_count" value="{{ old('children_count', $employee->children_count ?? 0) }}"
                            min="0" max="10"
                            ...
                            {{ old('marital_status', $employee->marital_status) != 'menikah' ? 'disabled' : '' }}>
            ...
            <div class="space-y-5">
                ...
                <div>
                    ...
                    <textarea name="address" rows="3"
                        ...
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('address', $employee->address) }}</textarea>
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <select name="employee_type" required class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                        ...
                        <option value="staff_tu" {{ old('employee_type', $employee->employee_type) == 'staff_tu' ? 'selected' : '' }}>Staff Tata Usaha</option>
                        <option value="staff_keuangan" {{ old('employee_type', $employee->employee_type) == 'staff_keuangan' ? 'selected' : '' }}>Staff Keuangan</option>
                        <option value="security" {{ old('employee_type', $employee->employee_type) == 'security' ? 'selected' : '' }}>Security</option>
                        <option value="cleaning_service" {{ old('employee_type', $employee->employee_type) == 'cleaning_service' ? 'selected' : '' }}>Cleaning Service</option>
                        <option value="driver" {{ old('employee_type', $employee->employee_type) == 'driver' ? 'selected' : '' }}>Driver</option>
                        <option value="other" {{ old('employee_type', $employee->employee_type) == 'other' ? 'selected' : '' }}>Lainnya</option>
                    </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <select name="employment_status" required class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                            <option value="">-- Pilih Status --</option>
                            <option value="yayasan" {{ old('employment_status', $employee->employment_status) == 'yayasan' ? 'selected' : '' }}>Yayasan</option>
                            <option value="pns" {{ old('employment_status', $employee->employment_status) == 'pns' ? 'selected' : '' }}>PNS</option>
                            <option value="pppk" {{ old('employment_status', $employee->employment_status) == 'pppk' ? 'selected' : '' }}>PPPK</option>
                            <option value="honorer" {{ old('employment_status', $employee->employment_status) == 'honorer' ? 'selected' : '' }}>Honorer</option>
                            <option value="percobaan" {{ old('employment_status', $employee->employment_status) == 'percobaan' ? 'selected' : '' }}>Percobaan</option>
                    ...
                    <div>
                        ...
                        <input type="date" name="tmt_date" value="{{ old('tmt_date', $employee->tmt_date?->format('Y-m-d')) }}" required
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="basic_salary" value="{{ old('basic_salary', $employee->basic_salary ?? 0) }}" required
