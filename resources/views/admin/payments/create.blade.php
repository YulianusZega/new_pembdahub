...
<div class="space-y-6">
    <div class="mb-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Catat Pembayaran</h1>
    ...
    <form action="{{ route('admin.payments.store') }}" method="POST">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 mb-6">
            <div class="space-y-5">
                <!-- Siswa -->
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2"><i class="fas fa-user mr-1"></i> Siswa</label>
                ...
                <!-- Tagihan (Optional) -->
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2"><i class="fas fa-clipboard mr-1"></i> Tagihan (Opsional)</label>
                ...
                <!-- Jumlah Bayar -->
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2"><i class="fas fa-coins mr-1"></i> Jumlah Bayar (Rp)</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2"><i class="fas fa-calendar-alt mr-1"></i> Tanggal Bayar</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2"><i class="fas fa-bookmark mr-1"></i> ID Transaksi</label>
                ...
                <div>
                    ...
                    <textarea name="notes" rows="3" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    @if(session('payment_id'))
        ...
        if (confirm('Pembayaran berhasil! Download kwitansi sekarang?')) {
            window.location.href = '/admin/payments/' + paymentId + '/receipt';
        }
    @endif
});
