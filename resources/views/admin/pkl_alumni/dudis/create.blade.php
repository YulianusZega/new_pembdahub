...
<div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-3xl mx-auto">
    ...
    <div class="sm:flex sm:justify-between sm:items-center mb-8">
        <div class="mb-4 sm:mb-0">
            <h1 class="text-2xl md:text-3xl text-slate-800 font-bold">Tambah Mitra Baru ✨</h1>
        </div>
    ...
    <div class="bg-white shadow-lg rounded-sm border border-slate-200 p-6">
        <form method="POST" action="{{ route('admin.pkl-alumni.dudis.store') }}">
            @csrf
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea id="address" name="address" rows="3" class="form-input w-full" required>{{ old('address') }}</textarea>
                ...
                <div>
                    ...
                    <input id="field_of_work" name="field_of_work" type="text" class="form-input w-full" value="{{ old('field_of_work') }}" placeholder="Misal: IT, Otomotif, Perbankan..." />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input id="mentor_name" name="mentor_name" type="text" class="form-input w-full" value="{{ old('mentor_name') }}" />
                    ...
                    <div>
                        ...
                        <input id="mentor_phone" name="mentor_phone" type="text" class="form-input w-full" value="{{ old('mentor_phone') }}" placeholder="Contoh: 081234567890" />
            ...
            <div class="mt-6 border-t border-slate-200 pt-5 flex justify-end">
                <button type="submit" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">Simpan Mitra DUDI</button>
            </div>
        </form>
    </div>
