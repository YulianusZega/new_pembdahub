            ...
            <table class="border-collapse">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        @foreach($classrooms as $classroom)
                        @php
                        $schedulesInCell = $schedules->where('classroom_id', $classroom->id);
                        @endphp
                        <td class="p-1 border border-gray-300 text-center text-xs relative group align-top" style="width: 100px; min-width: 100px; max-width: 100px;">
                            @if($schedulesInCell->count() > 0)
                            <div class="flex flex-col gap-1 w-full h-full">
                                @foreach($schedulesInCell as $schedule)
                                <div class="bg-gradient-to-br from-indigo-50 to-purple-50 p-1 rounded hover:shadow-md transition cursor-pointer relative group/item">
                                    <div class="font-semibold text-gray-800 text-xs" style="line-height: 1.1;">
                                    ...
                                    <div class="absolute top-1 right-1 hidden group-hover/item:flex gap-1 z-10">
