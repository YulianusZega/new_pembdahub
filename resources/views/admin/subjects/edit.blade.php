...
<div class="space-y-6">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-4 mb-2">
            ...
            <div>
                ...
                <p class="text-gray-600 mt-1">Perbarui informasi {{ $subject->subject_name }}</p>
            </div>
        </div>
    </div>
    ...
    <form action="{{ route('admin.subjects.update', $subject) }}" method="POST">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <textarea name="description" rows="4" 
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-pink-500 focus:border-transparent transition-all" 
                        placeholder="Jelaskan tentang mata pelajaran ini...">{{ old('description', $subject->description) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" name="kkm" value="{{ old('kkm', $subject->kkm ?? 75) }}" 
        ...
        <div class="flex items-center gap-4 justify-end bg-white rounded-2xl shadow-lg p-6">
            ...
            <button type="submit" 
                class="px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-xl font-medium hover:from-green-700 hover:to-green-800 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all">
                <span class="flex items-center gap-2">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
