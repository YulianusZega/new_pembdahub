        ...
        <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
            ...
            <div class="p-6 space-y-4">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name', $user->name) }}" class="w-full border-2 border-gray-200 p-3 rounded-xl focus:ring-2 focus:ring-gray-500 focus:border-transparent transition">
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2"><i class="fas fa-key mr-1"></i> Username</label>
                        <input type="text" name="username" value="{{ old('username', $user->username) }}" class="w-full border-2 border-gray-200 p-3 rounded-xl focus:ring-2 focus:ring-gray-500 focus:border-transparent transition">
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2"><i class="fas fa-envelope mr-1"></i> Email</label>
                        <input type="email" name="email" value="{{ old('email', $user->email) }}" class="w-full border-2 border-gray-200 p-3 rounded-xl focus:ring-2 focus:ring-gray-500 focus:border-transparent transition">
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2"><i class="fas fa-lock mr-1"></i> Password (isi jika ingin ganti)</label>
                        <input type="password" name="password" autocomplete="new-password" class="w-full border-2 border-gray-200 p-3 rounded-xl focus:ring-2 focus:ring-gray-500 focus:border-transparent transition">
                    </div>
                    <div>
                        ...
                        <input type="password" name="password_confirmation" autocomplete="new-password" class="w-full border-2 border-gray-200 p-3 rounded-xl focus:ring-2 focus:ring-gray-500 focus:border-transparent transition">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="p-6 space-y-4">
                <div>
                    ...
                    <select name="role" class="w-full border-2 border-gray-200 p-3 rounded-xl focus:ring-2 focus:ring-slate-500 focus:border-transparent transition">
                        ...
                        <option value="ketua_yayasan" {{ old('role', $user->role)=='ketua_yayasan' ? 'selected' : '' }}>Ketua Yayasan</option>
                ...
                <div class="flex items-center">
                    <label class="inline-flex items-center cursor-pointer">
                        <input type="checkbox" name="is_active" value="1" {{ $user->is_active ? 'checked' : '' }} class="w-5 h-5 text-gray-600 border-2 border-gray-300 rounded focus:ring-2 focus:ring-gray-500 mr-3">
