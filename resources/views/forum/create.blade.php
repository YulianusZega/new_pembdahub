...
<!-- App Window Wrapper -->
<div class="w-full bg-[#0f0f14] text-[#f8fafc] font-['Inter'] rounded-3xl shadow-2xl border border-white/10 mx-auto pt-4 pb-20 px-4 sm:px-6 relative" style="min-height: 85vh;" x-data="createPost()">
    ...
    <form action="{{ route('forum.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div class="space-y-3">
                    ...
                    <div x-show="hasTargetDonation" style="display:none;">
                        <input type="number" name="charity_target_amount" class="w-full px-5 py-3 bg-black/40 border border-white/10 focus:border-red-500 rounded-xl text-sm text-white outline-none" placeholder="Target Rp...">
                    </div>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    <div x-show="hasTargetVolunteers" style="display:none;">
                        <input type="number" name="charity_target_volunteers" class="w-full px-5 py-3 bg-black/40 border border-white/10 focus:border-red-500 rounded-xl text-sm text-white outline-none" placeholder="Jumlah orang...">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex gap-4">
            <a href="{{ route('forum.index') }}" class="px-6 py-4 rounded-xl bg-white/5 hover:bg-white/10 text-slate-300 font-bold transition flex items-center justify-center">
                Batal
            </a>
