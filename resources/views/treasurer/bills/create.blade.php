...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8 max-w-3xl">
    ...
    <form action="{{ route('treasurer.bills.store') }}" method="POST">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 mb-6">
            <div class="space-y-5">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">👤 Siswa <span class="text-red-500">*</span></label>
                    <select name="student_id" required id="student_select" class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-emerald-500">
